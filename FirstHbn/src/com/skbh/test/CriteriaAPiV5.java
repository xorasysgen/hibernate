...
public class CriteriaAPiV5 {
	...
	private static void functionTest() {
        ...
        // Get max salary
			 ...
			 * criteriaQuery2.select(builder.max(root2.get("salary"))); Query<Integer>
			 * query2 = session.createQuery(criteriaQuery2); int maxSalary =
			 * query2.getSingleResult(); System.out.println("Max Salary = " + maxSalary);
			 * 
			 * // Get Average Salary CriteriaQuery<Double> criteriaQuery3 =
			 * builder.createQuery(Double.class); Root<Employee> root3 =
			 * criteriaQuery3.from(Employee.class);
			 * criteriaQuery3.select(builder.avg(root3.get("salary"))); Query<Double> query3
			 * = session.createQuery(criteriaQuery3); double avgSalary =
			 * query3.getSingleResult(); System.out.println("Average Salary = " +
			 * avgSalary);
			 */
